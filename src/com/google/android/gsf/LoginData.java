...
public class LoginData implements Parcelable {
	public static final android.os.Parcelable.Creator<LoginData> CREATOR =
			new android.os.Parcelable.Creator<LoginData>() {
	...
	public enum Status {
		ACCOUNT_DISABLED, BAD_REQUEST, BAD_USERNAME, CANCELLED, CAPTCHA, DELETED_GMAIL, DMAGENT, LOGIN_FAIL,
		MISSING_APPS, NETWORK_ERROR, NO_GMAIL, OAUTH_MIGRATION_REQUIRED, SERVER_ERROR, SUCCESS;
	}
}
